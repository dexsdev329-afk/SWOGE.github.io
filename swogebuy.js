...
(function () {
   ...
   * dise a un tiers quelles pages du site sont regardees. Six kilo-octets en
   * tout — le prix d'une seule des images deja presentes.
   *
   * Ce sont les logos fournis, pas ceux d'un jeu d'icones : celui de Base est
   * la vraie marque et non la tuile bleue aplatie que servent les CDN, et le
   * bouton TRON porte celle de Tether, ce qui est plus juste puisque c'est de
   * l'USDT qu'on y envoie — le TRX natif n'a pas de route.
   *
   * Deux retouches, dites parce qu'elles ne se devinent pas : l'ether arrivait
   * avec un damier OPAQUE dans les coins — la capture d'un apercu de
   * transparence — enleve par un masque circulaire, sa marque etant un disque
   * qui remplit le cadre ; et le losange de Tether est pose au centre d'une
   * toile carree, sinon une image plus large que haute s'ecrase dans une case
   * carree et se retrouve plus petite que ses voisines.
   *
   * Trente-six pixels : deux fois la taille d'affichage, pour les ecrans fins.
   */
  var ICONES = {
    sol: 'data:image/webp;base64,',
    eth: 'data:image/webp;base64,',
    base: 'data:image/webp;base64,',
    tron: 'data:image/webp;base64,',
    btc: 'data:image/webp;base64,'
  };
