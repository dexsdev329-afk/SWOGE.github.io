...
(function () {
      ...
      '<div class="swb-b" id="swbCorps">' +
        ...
        '<div class="swb-x" id="swbAilleurs">' +
          ...
          '<div>' +
            ...
            bouton6('base', 'Base') + bouton6('arb', 'Arbitrum') +
            bouton6('op', 'Optimism') +
          '</div>' +
  ...
  var DEPUIS = {
    ...
    arb:   { chaine: 42161,     jeton: NATIF, unite: 'ETH' },
    op:    { chaine: 10,        jeton: NATIF, unite: 'ETH' },
  };
  ...
  var ICONES = {
    ...
    arb: 'data:image/webp;base64,',
    op: 'data:image/webp;base64,',
